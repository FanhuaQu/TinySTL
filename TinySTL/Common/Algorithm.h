...
namespace TinySTL
{
    ...
    /*fill_n. Algorithm complexity O(N)*/
    ...
    /*make_heap Algorithm complexity O(n)*/
    ...
    static void up(RandomAccessIterator first, RandomAccessIterator last, RandomAccessIterator head, Compare comp)
    {
        ...
        {
            int index = last - head;
            auto parentIndex = (index - 1) / 2; // 父节点的索引
    ...
    static void down(RandomAccessIterator first, RandomAccessIterator last, RandomAccessIterator head, Compare comp)
    {
        if (first != last)
        {
            ...
            {
                auto child = head + leftChildIndex; // get left child index
    ...
    {
        TinySTL::make_heap(first, last,  TinySTL::less<typename TinySTL::iterator_traits<RandomAccessIterator>::value_type>());
    }
    template <class RandomAccessIterator, class Compare>
    ...
    /*push_heap Algorithm complexity O(lgN)*/
    template <class RandomAccessIterator>
    ...
    /*pop_heap Algorithm Complexity O(lgN)*/
    template <class RandomAccessIterator>
    ...
    /*sort_heap Algorithm Complexity O(N)*/
    template <class RandomAccessIterator>
    ...
    /*is_heap Algorithm Complexity O(N)*/
    template <class RandomAccessIterator>
    ...
    /*all_of Algorithm Complexity O(N)*/
    ...
    /*any_of Algorithm Complexity O(N)*/
    template <class InputIterator, class UnaryPredicate>
    ...
    /*none_of Algorithm complexity O(N) */
    template <class InputIterator, class UnaryPredicate>
    ...
    /*for_each Algorithm complexity O(N)*/
    ...
    InputIterator find(InputIterator first, InputIterator last, const T &val)
    {
        ...
        return first; // return iterator
    }
    /*find_if Algorithm Complexity O(N)*/
    template <class InputIterator, class UnaryPredicate>
    ...
    /*find_if_not Algorithm Complexity O(N)*/
    template <class InputIterator, class UnaryPredicate>
    ...
    /*find_end, Algorithm Complexity O(N*N)
     * 在范围内查找子序列出现的位置
     */
    template <class ForwardIterator1, class ForwardIterator2>
    ForwardIterator1 find_end(ForwardIterator1 first1, ForwardIterator1 last1, ForwardIterator2 first2, ForwardIterator2 last2)
    {
        if (first2 == last2) // 子序列空
            return last1;
        ForwardIterator1 ret = last1; // 默认的返回值
        while (first1 != last1)
        {
    ...
    /*find_first_of Algorighm complexity O(N*N)*/
    template <class ForwardIterator1, class ForwardIterator2>
    ...
    /*adjacent_find Algorithm Complexity O(N)*/
    template <class ForwardIterator, class BinaryPredicate>
    ForwardIterator adjacent_find(ForwardIterator first, ForwardIterator last)
    {
        return TinySTL::adjacent_find(first, last, TinySTL::equal_to<typename iterator_traits< ForwardIterator>::value_type>());
    }
    template <class ForwardIterator, class BinaryPredicate>
    ...
    /*count Algorithm Complexity O(N)*/
    template <class InputIterator, class T>
    ...
    /*is_permutation
     * 检查一个范围内元素是否是另一个范围内元素的一个排列
     */
    template <class ForwardIterator1, class ForwardIterator2>
    bool is_permutation(ForwardIterator1 first1, ForwardIterator1 last1, ForwardIterator2 first2)
    {
        return TinySTL::is_permutation(first1, last1, first2, TinySTL::equal_to<typename TinySTL::iterator_traits<ForwardIterator1>::value_type>());
    }
    template <class ForwardIterator1, class ForwardIterator2, class BinaryPredicate>
    bool is_permutation(ForwardIterator1 first1, ForwardIterator1 last1, ForwardIterator2 first2, BinaryPredicate pred)
    {
        ...
        auto res = TinySTL::mismatch(first1, last1, first2, pred); // 返回一个pair
        first1 = res.first;
        first2 = res.second;
        if (first1 == last1) // 说明完全匹配
            return true;
        auto last2 = first2;
        std::advance(last2, std::distance(first1, last1)); // 将last2设置为first2开头相同长度的末尾
    ...
    {
        return TinySTL::search(first1, last1, first2, last2, TinySTL::equal_to<typename TinySTL::iterator_traits<ForwardIterator1>::value_type>());
    }
    template <class ForwardIterator1, class ForwardIterator2, class BinaryPredicate>
    ...
    namespace
    {
        ...
        typename iterator_traits<RandomIterator>::value_type mid3(RandomIterator first, RandomIterator last, BinaryPredicate pred)
        { //[first, last]
