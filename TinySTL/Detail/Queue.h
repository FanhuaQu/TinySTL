...
namespace TinySTL
{
    ...
    public:
        ...
        friend bool operator!=(const queue<T1, Container1> &lhs, const queue<T1, Container1> &rhs);
        template <class T1, class Container1>
        friend void swap(queue<T1, Container1> &x, queue<T1, Container1> &y);
    };
    ...
    public:
        explicit priority_queue(const Compare &comp = Compare(), const Container &ctnr = Container()) : container_(ctnr), compare_(comp) {}
        template <class InputIterator>
        priority_queue(InputIterator first, InputIterator last, const Compare &comp = Compare(), const Container &ctnr = Container()) : container_(ctnr), compare_(comp)
        {
    ...
    public:
        ...
        friend void swap(priority_queue<T1, Container1, Compare1> &x, priority_queue<T1, Container1, Compare1> &y);
    };
